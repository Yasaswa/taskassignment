...
ALTER TABLE xt_sizing_production_stock_details ADD gross_weight decimal(18,4) DEFAULT NULL NULL;
ALTER TABLE xt_sizing_production_stock_details ADD tare_weight decimal(18,4) DEFAULT NULL NULL;
ALTER TABLE xt_sizing_production_stock_details ADD net_weight decimal(18,4) DEFAULT NULL NULL;
