ALTER TABLE st_indent_material_issue_return_master ADD material_type varchar(3) DEFAULT 'UR' null after financial_year;
ALTER TABLE st_indent_material_issue_return_master ADD product_category1_id INT(10) null after indent_issue_return_type ;
ALTER TABLE st_indent_material_issue_return_master ADD product_category2_id INT(10) null after product_category1_id ;

ALTER TABLE  st_indent_material_issue_return_details ADD material_batch_rate double(18,4) DEFAULT 0.0000 NULL AFTER issue_return_remark;
ALTER TABLE  st_indent_material_issue_return_details ADD product_category1_id BIGINT(20) DEFAULT 0 NULL AFTER material_batch_rate;
ALTER TABLE  st_indent_material_issue_return_details ADD product_category2_id BIGINT(20) DEFAULT 0 NULL AFTER product_category1_id;
...
select
    ...
    concat(`v`.`return_by_id`, ':Issue Return By Id:N:N:') as `return_by_id`,
    concat(`v`.`indent_issue_return_type_id`, ':Issue Return Type Id:N:N:') as `indent_issue_return_type_id`,
    concat(`v`.`department_id`, ':Department Id:N:N:') as `department_id`,
    concat(`v`.`sub_department_id`, ':Sub Department Id:N:N:') as `sub_department_id`,
    concat(`v`.`company_id`, ':Company Id:N:N:') as `company_id`
from
