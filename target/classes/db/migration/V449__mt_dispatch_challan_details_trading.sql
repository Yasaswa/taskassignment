ALTER TABLE mt_dispatch_challan_master_trading ADD driver_name varchar(100) NULL;
ALTER TABLE mt_dispatch_inspection_details_trading ADD `style` varchar(100) NULL;
ALTER TABLE mt_dispatch_inspection_details_trading ADD glm varchar(100) NULL;


-- erp_dev.mtv_dispatch_challan_master_trading source
...
-- erp_dev.mtv_dispatch_inspection_details_trading source
...
-- erp_dev.mtv_dispatch_challan_batchwise_trading source
