...
CREATE TABLE `pt_inter_material_transfer_master` (
  `inter_material_transfer_master_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '* read only back end auto generated *',
  `financial_year` varchar(20) NOT NULL COMMENT '*backend from session  *',
  `product_type_id` bigint(20) NOT NULL,
  `product_type_name` varchar(20) NOT NULL,
  `inter_material_transfer_no` varchar(50) NOT NULL,
  `inter_material_transfer_date` date NOT NULL,
  ...
  `inter_material_transfer_status` varchar(3) DEFAULT 'P' COMMENT 'P-Pending,A-Aprroved, R-Rejected,I-Partial Issue, MI-Material Issued',
  `company_id` bigint(20) DEFAULT NULL COMMENT 'get from session',
  `company_branch_id` bigint(20) DEFAULT NULL COMMENT 'get from session',
  ...
  PRIMARY KEY (`inter_material_transfer_master_id`)
);


CREATE TABLE `pt_inter_material_transfer_details` (
  `inter_material_transfer_details_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `inter_material_transfer_master_id` bigint(20) NOT NULL,
  `financial_year` varchar(20) NOT NULL COMMENT '*backend from session  *',
  `inter_material_transfer_no` varchar(50) NOT NULL,
  `inter_material_transfer_date` date NOT NULL,
  ...
  `product_material_id` varchar(20) DEFAULT NULL,
  `from_godown_id` bigint(20) DEFAULT NULL,
  `from_godown_section_id` bigint(20) DEFAULT NULL,
  `from_godown_section_beans_id` bigint(20) DEFAULT NULL,
  `to_godown_id` bigint(20) DEFAULT NULL,
  `to_godown_section_id` bigint(20) DEFAULT NULL,
  `to_godown_section_beans_id` bigint(20) DEFAULT NULL,
  ...
  `internal_material_transfer_remark` varchar(200) DEFAULT NULL,
  `inter_material_transfer_quantity` decimal(18,4) DEFAULT 0.0000 COMMENT '* NO Front End Only  Back End Entry Data will come from respective transaction will updated on transaction to transaction  level  *',
  `inter_material_transfer_weight` decimal(18,4) DEFAULT 0.0000 COMMENT '* NO Front End Only  Back End Entry Data will come from respective transaction will updated on transaction to transaction  level  *',
  `inter_material_transfer_boxes` bigint(20) DEFAULT NULL,
  ...
  PRIMARY KEY (`inter_material_transfer_details_id`)
);
...
left join `sm_product_rm_stock_details` `sprsd` on 
    (`sprsd`.`product_rm_id` = `pt`.`product_material_id`
        and `sprsd`.`is_delete` = 0 and `sprsd`.`supplier_id` = `pt`.`supplier_id`
        and `pt`.`from_godown_id` = `sprsd`.`godown_id` and `pt`.`from_godown_section_id` = `sprsd`.`godown_section_id` and `pt`.`from_godown_section_beans_id` = `sprsd`.`godown_section_beans_id`))
