ALTER TABLE pt_cotton_bales_sales_payment_terms CHANGE goods_return_date sales_return_date date NOT NULL COMMENT '* DTPpicker Data Entry';


ALTER TABLE pt_cotton_bales_sales_master ADD sales_dispatch_type varchar(100) NULL;
ALTER TABLE pt_cotton_bales_sales_master ADD dispatch_sales_type varchar(100) NULL;
ALTER TABLE pt_cotton_bales_sales_master MODIFY COLUMN customer_address BLOB NOT NULL COMMENT ' * will used from  Header part data';
ALTER TABLE pt_cotton_bales_sales_master MODIFY COLUMN consignee_address varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL NULL COMMENT ' * will used from  Header part data';


ALTER TABLE pt_cotton_bales_sales_details MODIFY COLUMN sales_return_remark varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT ' * will used from  Header part data';
ALTER TABLE pt_cotton_bales_sales_details ADD sales_dispatch_type varchar(100) NULL;
ALTER TABLE pt_cotton_bales_sales_details ADD dispatch_sales_type varchar(100) NULL;
ALTER TABLE pt_cotton_bales_sales_details ADD product_rm_std_weight decimal(18,4) DEFAULT 0.0 NULL;
...
select
    ...
    `cbsm`.`sales_dispatch_type` as `sales_dispatch_type`,
    `cbsm`.`dispatch_sales_type` as `dispatch_sales_type`,
...
select
    ...
    concat(ifnull(`v`.`return_by_name`, ''), ':Return By:Y:C:cmv_employee_list:F') as `return_by_name`,
