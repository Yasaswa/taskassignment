...
ALTER TABLE sm_product_rm_stock_summary ADD production_no_of_boxes BIGINT(20) DEFAULT 0 null COMMENT 'for store no. of rolls';
ALTER TABLE sm_product_rm_stock_summary CHANGE production_no_of_boxes production_no_of_boxes BIGINT(20) DEFAULT 0 NULL AFTER production_weight;
ALTER TABLE sm_product_rm_stock_summary ADD sales_no_of_boxes BIGINT(20) DEFAULT 0 NULL COMMENT 'for store no. of rolls';
ALTER TABLE sm_product_rm_stock_summary CHANGE sales_no_of_boxes sales_no_of_boxes BIGINT(20) DEFAULT 0 NULL COMMENT 'for store no. of rolls' AFTER sales_weight;
...
ALTER TABLE sm_product_rm_stock_details ADD production_no_of_boxes BIGINT(20) DEFAULT 0 null COMMENT 'for store no. of rolls';
ALTER TABLE sm_product_rm_stock_details CHANGE production_no_of_boxes production_no_of_boxes BIGINT(20) DEFAULT 0 NULL AFTER production_weight;
ALTER TABLE sm_product_rm_stock_details ADD sales_no_of_boxes BIGINT(20) DEFAULT 0 NULL COMMENT 'for store no. of rolls';
ALTER TABLE sm_product_rm_stock_details CHANGE sales_no_of_boxes sales_no_of_boxes BIGINT(20) DEFAULT 0 NULL COMMENT 'for store no. of rolls' AFTER sales_weight;
