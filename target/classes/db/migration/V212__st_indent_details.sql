...
-- st_indent_details
ALTER TABLE st_indent_details ADD product_material_preclosed_quantity DECIMAL(10,0) DEFAULT 0 NULL COMMENT 'preclose value added after preclose partial amount' AFTER product_child_bom_weight;
ALTER TABLE st_indent_details  ADD product_material_preclosed_weight DECIMAL(10,0) DEFAULT 0 NULL AFTER product_material_preclosed_quantity;
ALTER TABLE st_indent_details ADD preclosed_remark VARCHAR(100) DEFAULT NULL AFTER remark;

-- st_indent_master
ALTER TABLE st_indent_master ADD preclosed_remark varchar(100) DEFAULT NULL NULL;

-- st_indent_schedules
ALTER TABLE st_indent_schedules ADD preclosed_remark varchar(100) DEFAULT NULL NULL;
ALTER TABLE st_indent_schedules CHANGE preclosed_remark preclosed_remark varchar(100) DEFAULT NULL NULL AFTER remark;
ALTER TABLE st_indent_schedules ADD product_material_preclosed_quantity DECIMAL DEFAULT 0 NULL;
ALTER TABLE st_indent_schedules CHANGE product_material_preclosed_quantity product_material_preclosed_quantity DECIMAL DEFAULT 0 NULL AFTER material_weight;
ALTER TABLE st_indent_schedules ADD product_material_preclosed_weight DECIMAL DEFAULT 0 NULL;
ALTER TABLE st_indent_schedules CHANGE product_material_preclosed_weight product_material_preclosed_weight DECIMAL DEFAULT 0 NULL AFTER product_material_preclosed_quantity;
