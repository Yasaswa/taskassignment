...
select
    ...
    concat(ifnull(`v`.`indent_item_status_desc`, ''), ':Indent Material Status:Y:H:(Pending,Approved,Canceled,Rejected,Completed,Cancel)') as `indent_item_status_desc`,
    concat(ifnull(`v`.`indent_status_desc`, ''), ':Indent Material Status:Y:H:(Pending,Approved,Canceled,Rejected,Completed,Cancel)') as `indent_status_desc`,
    ...
    concat(ifnull(`v`.`po_status_desc`, ''), ':PO Material Status:Y:H:(Pending,Purchse Order Genreated,Partial PO Genreated,Purchse Order Approved,Cancel)') as `po_status_desc`,
