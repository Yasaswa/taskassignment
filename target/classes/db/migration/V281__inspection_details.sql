ALTER TABLE xt_weaving_production_inspection_details ADD godown_section_id bigint(20) NULL;
ALTER TABLE xt_weaving_production_inspection_details ADD godown_section_beans_id bigint(20) NULL;
