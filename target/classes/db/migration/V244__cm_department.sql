-- developent_db.cmv_department source

create or REPLACE algorithm = UNDEFINED view `cmv_department` as
select
...
order by
    ...
    -- developent_db.cmv_department_rpt source
    ...
    select
        ...
        concat(ifnull(`v`.`department_name`, ''), ':Parent Department:Y:C:cmv_department:O') as `parent_department`,
        concat(ifnull(`v`.`department_cost_center_name`, ''), ':Cost Center Name:Y:C:fmv_cost_center:F') as `department_cost_center_name`,
        concat(ifnull(`v`.`department_profit_center_name`, ''), ':Profit Center Name:Y:C:fmv_profit_center:F') as `department_profit_center_name`,
        ...
        concat(ifnull(`v`.`cost_center_short_name`, ''), ':Cost Center Short Name:O:N:') as `cost_center_short_name`,
        concat(ifnull(`v`.`profit_center_short_name`, ''), ':Profit Center Short Name:O:N:') as `profit_center_short_name`,
        ...
        concat(ifnull(`v`.`cost_center_id`, ''), ':Cost Center Id:N:N:') as `cost_center_id`,
        concat(ifnull(`v`.`profit_center_id`, ''), ':Profit Center Id:N:N:') as `profit_center_id`,
