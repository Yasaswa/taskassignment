ALTER TABLE st_indent_material_issue_details ADD issue_requisition_type varchar(2) DEFAULT 'M' NULL;
ALTER TABLE xt_warping_production_order_stock_details ADD issue_requisition_type varchar(2) DEFAULT "M" NULL;

ALTER TABLE xt_warping_production_order_stock_details ADD batch_no varchar(100) NULL;
