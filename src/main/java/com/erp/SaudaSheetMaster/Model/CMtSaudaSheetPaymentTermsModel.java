...
@Data
@Entity
@Table(name="mt_sauda_sheet_payment_terms")
public class CMtSaudaSheetPaymentTermsModel {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "sauda_sheet_payment_terms_transaction_id")
    private int sauda_sheet_payment_terms_transaction_id;
