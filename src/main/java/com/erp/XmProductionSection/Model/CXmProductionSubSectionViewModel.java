...
@Entity
@Immutable
@Subselect("SELECT * FROM xmv_production_sub_section")
public class CXmProductionSubSectionViewModel {
	...
	private String production_sub_section_cost_center;
	private String production_sub_section_profit_center;
	private String production_sub_section_head;
	private String production_sub_section_subhead;
	private String production_sub_section_std_staff_strength;
	private String production_sub_section_std_worker_strength;
