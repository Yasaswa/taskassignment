...
@Entity
@Immutable
@Subselect("select * from mtv_sales_quotation_existing_expected_functionality_services")
public class CMtSalesQuotationExistingExpectedFunctionalityServiceViewModel {
