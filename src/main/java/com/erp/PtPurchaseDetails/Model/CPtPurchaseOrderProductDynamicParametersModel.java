...
@Data
@Entity
@Table(name = "pt_purchase_order_product_dynamic_parameters")
public class CPtPurchaseOrderProductDynamicParametersModel {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "purchase_order_parameter_id")
    private Integer purchase_order_parameter_id;
