...
@Entity
@Immutable
@Subselect("select * from ptv_purchase_order_payment_terms")
public class CPtPurchaseOrderPaymentTermsViewModel {
	...
	public CPtPurchaseOrderPaymentTermsViewModel(int purchase_order_payment_terms_transaction_id, String company_name,
	                                             ...
	                                             String payment_expected_date, String payment_paid_flag, String payment_paid_transaction_id,
	                                             String payment_paid_date, String remark, boolean is_active, boolean is_delete, String created_by,
	                                             Date created_on, String modified_by, Date modified_on, String deleted_by, Date deleted_on,
	                                             Integer company_id, Integer company_branch_id, Integer purchase_order_master_transaction_id,
	                                             Integer purchase_order_details_transaction_id, Integer payment_terms_id) {
		super();
		this.purchase_order_payment_terms_transaction_id = purchase_order_payment_terms_transaction_id;
		this.company_name = company_name;
		this.company_branch_name = company_branch_name;
	...
	public CPtPurchaseOrderPaymentTermsViewModel() {
		super();
