...
@Data
@Entity
@Table(name = "hm_employee_type_earning_mapping")
public class CHmEmployeeTypeEarningMappingModel {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "employee_type_eraning_mapping_id")
	private int employee_type_eraning_mapping_id;
