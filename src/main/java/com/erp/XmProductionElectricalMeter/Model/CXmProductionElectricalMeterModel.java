...
@NoArgsConstructor
@Entity
@Table(name = "xm_production_electrical_meter")
public class CXmProductionElectricalMeterModel {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "prod_electrical_meter_id")
	private int prod_electrical_meter_id;
