...
@NoArgsConstructor
@Entity
@Table(name = "xm_production_electrical_meter_machine_mapping")
public class CXmProductionElectricalMeterMachineMappingModel {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "prod_electrical_meter_machine_mapping_id")
