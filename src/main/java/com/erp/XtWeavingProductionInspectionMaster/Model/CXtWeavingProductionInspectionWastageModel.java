...
@Data
@Entity
@Table(name = "xt_weaving_production_inspection_wastage")
public class CXtWeavingProductionInspectionWastageModel {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "weaving_production_inspection_wastage_id")
	private int weaving_production_inspection_wastage_id;
