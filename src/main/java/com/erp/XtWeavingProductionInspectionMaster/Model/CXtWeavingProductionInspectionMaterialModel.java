...
@Data
@Entity
@Table(name = "xt_weaving_production_inspection_material")
public class CXtWeavingProductionInspectionMaterialModel {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "weaving_production_inspection_material_id")
	private int weaving_production_inspection_material_id;
	...
	private String inspection_production_order_no;
