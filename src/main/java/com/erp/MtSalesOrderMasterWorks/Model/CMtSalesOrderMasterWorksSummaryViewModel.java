...
@Entity
@Immutable
@Subselect("select * from  mtv_sales_order_master_works_summary")
public class CMtSalesOrderMasterWorksSummaryViewModel {
	...
	public CMtSalesOrderMasterWorksSummaryViewModel(int sales_order_master_transaction_id, String company_name,
	...
	public CMtSalesOrderMasterWorksSummaryViewModel() {
		super();
