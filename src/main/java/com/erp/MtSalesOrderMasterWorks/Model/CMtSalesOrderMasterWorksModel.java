...
@Data
@Entity
@Table(name = "mt_sales_order_master_works")
public class CMtSalesOrderMasterWorksModel {
	...
	public CMtSalesOrderMasterWorksModel(int sales_order_master_transaction_id, Integer company_id,
	                                     ...
	                                     String sales_order_status, String status_remark, String sales_quotation_no, Date sales_quotation_date,
	...
	public CMtSalesOrderMasterWorksModel() {
		super();
	}
