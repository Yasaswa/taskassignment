...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "ptv_material_return_gate_pass_details")
public class CPtMaterialReturnGatePassDetailsViewModel {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "material_return_gate_pass_details_id",nullable = false)
    private Integer material_return_gate_pass_details_id;
...
//    private String gate_pass_no;
    ...
    private String return_item_status_desc;
