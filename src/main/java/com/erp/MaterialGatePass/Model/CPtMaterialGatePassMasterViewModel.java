...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "ptv_material_gate_pass_master")
public class CPtMaterialGatePassMasterViewModel {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "material_gate_pass_master_id", nullable = false)
    ...
    private String gate_pass_status;
    private String gate_pass_status_desc;
    ...
    private boolean is_deduct_stock;
