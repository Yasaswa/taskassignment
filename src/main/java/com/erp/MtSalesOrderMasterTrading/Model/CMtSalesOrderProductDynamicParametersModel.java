...
@Data
@Entity
@Table(name = "mt_sales_order_product_dynamic_parameters")
public class CMtSalesOrderProductDynamicParametersModel {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "sales_order_parameter_id")
	private int sales_order_parameter_id;
