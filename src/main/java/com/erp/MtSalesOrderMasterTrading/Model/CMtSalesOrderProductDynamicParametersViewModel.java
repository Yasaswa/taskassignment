...
@Entity
@Immutable
@Subselect("select * from  mtv_sales_order_product_dynamic_parameters")
public class CMtSalesOrderProductDynamicParametersViewModel {

	@Id
	private Integer sales_order_parameter_id;
