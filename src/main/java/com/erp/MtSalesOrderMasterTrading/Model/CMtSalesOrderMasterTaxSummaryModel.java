...
@Data
@Entity
@Table(name = "mt_sales_order_tax_summary")
@JsonIgnoreProperties(ignoreUnknown = true)
public class CMtSalesOrderMasterTaxSummaryModel {
	...
	public CMtSalesOrderMasterTaxSummaryModel(int sales_order_tax_summary_transaction_id, Integer company_id,
	                                          Integer company_branch_id, String financial_year, Integer sales_order_type_id, String sales_order_type,
	                                          Integer sales_order_master_transaction_id, Integer customer_id, Integer customer_state_id,
	                                          Integer customer_city_id, String customer_contacts_ids, Integer expected_branch_id,
	                                          Integer expected_branch_state_id, Integer expected_branch_city_id, String sales_order_no,
	                                          String sales_order_date, Integer sales_order_version, int hsn_code_id, double summary_taxable_amount,
	...
	public CMtSalesOrderMasterTaxSummaryModel() {
		super();
