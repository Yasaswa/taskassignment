...
@Entity
@Immutable
@Subselect("select * from  mtv_sales_order_master_trading_summary_rpt")
public class CMtSalesOrderMasterTradingSummaryRptModel_Not_Used {
	...
	public CMtSalesOrderMasterTradingSummaryRptModel_Not_Used(String sales_order_master_transaction_id, String company_name,
	                                                          String company_branch_name, String financial_year, String sales_order_type, String sales_order_life_desc,
	                                                          String sales_order_creation_type_desc, String sales_order_life, String sales_order_creation_type,
	                                                          ...
	                                                          String other_amount, String hsn_sac_type, String hsn_sac_code, String hsn_sac_description,
	                                                          String hsn_sac_rate, String taxable_total, String cgst_percent, String cgst_total, String sgst_percent,
	                                                          String sgst_total, String igst_percent, String igst_total, String roundoff, String grand_total,
	                                                          String agent_name, String agent_percent, String agent_paid_status,
	                                                          String sales_order_acceptance_status_desc, String sales_order_acceptance_status,
	                                                          String sales_order_mail_sent_status, String sales_order_mail_sent_status_desc, String sales_order_status,
	                                                          String status_remark, String sales_quotation_no, String sales_quotation_date, String other_terms_conditions,
	                                                          String remark, String is_active, String is_delete, String created_by, String created_on, String modified_by,
	                                                          String modified_on, String deleted_by, String deleted_on, String company_id, String company_branch_id,
	                                                          String sales_order_type_id, String customer_id, String freight_hsn_code_id, String customer_state_id,
	                                                          String customer_city_id, String consignee_id, String consignee_state_id, String consignee_city_id,
	                                                          String department_id, String approved_by_id, String agent_id) {
		super();
		this.sales_order_master_transaction_id = sales_order_master_transaction_id;
		this.company_name = company_name;
		this.company_branch_name = company_branch_name;
	...
	public CMtSalesOrderMasterTradingSummaryRptModel_Not_Used() {
		super();
