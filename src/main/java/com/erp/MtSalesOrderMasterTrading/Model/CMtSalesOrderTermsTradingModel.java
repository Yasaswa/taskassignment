...
@Data
@Entity
@Table(name = "mt_sales_order_terms_trading")
@JsonIgnoreProperties(ignoreUnknown = true)
public class CMtSalesOrderTermsTradingModel {
	...
	public CMtSalesOrderTermsTradingModel(int sales_order_terms_transaction_id, Integer company_id,
	                                      ...
	                                      Integer sales_order_version, String customer_order_no, String customer_order_Date,
	                                      Integer sales_order_terms_parameters_id, String sales_order_terms_parameters_name,
	...
	public CMtSalesOrderTermsTradingModel() {
		super();
