...
@Entity
@Immutable
@Subselect("select * from mtv_sales_order_payment_terms_trading")
public class CMtSalesOrderPaymentTermsTradingViewModel {
	...
	public CMtSalesOrderPaymentTermsTradingViewModel(int sales_order_payment_terms_transaction_id, String company_name,
	                                                 String company_branch_name, String sales_order_no, String sales_order_date, Integer sales_order_version,
	                                                 String customer_order_no, String customer_order_Date, String payment_terms_name, String payment_terms_days,
	                                                 Integer payment_terms_grace_days, String payment_terms_Milestome, String payment_percent,
	                                                 double payment_expected_value, String payment_expected_date, String payment_receipt_flag,
	                                                 String payment_receipt_transaction_id, String payment_receipt_date, String remark, boolean is_active,
	...
	public CMtSalesOrderPaymentTermsTradingViewModel() {
		super();
	}
