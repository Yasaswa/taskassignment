package com.erp.MtSalesOrderMasterProjects.Model;
...
@Data
@Entity
@Table(name = "mt_sales_order_master_projects")
public class CMtSalesOrderMasterProjectsModel {
	...
	public CMtSalesOrderMasterProjectsModel(int sales_order_master_transaction_id, Integer company_id,
	                                        Integer company_branch_id, String financial_year, Integer sales_order_type_id, String sales_order_type,
	                                        String sales_order_life, String sales_order_no, String sales_order_date, Integer sales_order_version,
	                                        Integer customer_id, Integer customer_state_id, Integer customer_city_id, Integer consignee_id,
	                                        Integer consignee_state_id, Integer consignee_city_id, String customer_order_no, String customer_order_Date,
	                                        Integer department_id, Integer approved_by_id, String approved_date, String overall_schedule_date,
	                                        double basic_total, double transport_amount, double freight_amount, double packing_amount,
	                                        double discount_percent, double discount_amount, double other_amount, double taxable_total,
	                                        double cgst_percent, double cgst_total, double sgst_percent, double sgst_total, double igst_percent,
	                                        double igst_total, double roundoff, double grand_total, Integer agent_id, double agent_percent,
	                                        String agent_paid_status, String sales_order_acceptance_status, String sales_order_mail_sent_status,
	                                        String sales_order_status, String status_remark, String remark, boolean is_active, boolean is_delete,
	                                        String created_by, Date created_on, String modified_by, Date modified_on, String deleted_by,
	                                        Date deleted_on, String customer_contacts_ids) {
		super();
		this.sales_order_master_transaction_id = sales_order_master_transaction_id;
		this.company_id = company_id;
		this.company_branch_id = company_branch_id;
	...
	public CMtSalesOrderMasterProjectsModel() {
		super();
	}
