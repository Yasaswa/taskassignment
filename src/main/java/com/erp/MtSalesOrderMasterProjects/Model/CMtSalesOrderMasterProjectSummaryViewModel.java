...
@Entity
@Immutable
@Subselect("select * from mtv_sales_order_master_projects_summary")
public class CMtSalesOrderMasterProjectSummaryViewModel {
	...
	public CMtSalesOrderMasterProjectSummaryViewModel(int sales_order_master_transaction_id, String company_name,
	                                                  ...
	                                                  String sales_order_mail_sent_status, String sales_order_status, String sales_order_status_desc,
	                                                  String sales_order_acceptance_status_desc, String sales_order_mail_sent_status_desc, String status_remark,
	                                                  String remark, boolean is_active, boolean is_delete, String created_by, Date created_on, String modified_by,
	                                                  Date modified_on, String deleted_by, Date deleted_on, Integer sales_order_type_id, Integer company_id,
	                                                  Integer company_branch_id, Integer customer_id, Integer customer_state_id, Integer customer_city_id,
	                                                  Integer consignee_id, Integer consignee_state_id, Integer consignee_city_id, Integer department_id,
	                                                  Integer approved_by_id, Integer agent_id, String customer_contacts_ids) {
		super();
		this.sales_order_master_transaction_id = sales_order_master_transaction_id;
		this.company_name = company_name;
		this.company_branch_name = company_branch_name;
	...
	public CMtSalesOrderMasterProjectSummaryViewModel() {
		super();
