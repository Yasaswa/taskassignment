...
@Data
@Entity
@Table(name = "sm_product_rm_qa_mapping")
public class CSmProductRmQaMappingModel {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "product_rm_qa_mapping_id")
	private int product_rm_qa_mapping_id;
	...
	public int getproduct_rm_qa_mapping_id() {
		return product_rm_qa_mapping_id;
	}

	public void setproduct_rm_qa_mapping_id(int product_rm_qa_mapping_id) {
		this.product_rm_qa_mapping_id = product_rm_qa_mapping_id;
	}
	...
	public CSmProductRmQaMappingModel(int product_rm_qa_mapping_id, Integer company_id, Integer company_branch_id,
	                                  String product_rm_id, Integer product_qa_parameters_id, double product_rm_qa_from_range,
	                                  double product_rm_qa_to_range, double product_rm_qa_from_deviation_percent,
	                                  double product_rm_qa_to_deviation_percent, String remark, boolean is_active, boolean is_delete,
	...
	public CSmProductRmQaMappingModel() {
		super();
	}
