...
@Entity
@Immutable
@Subselect("select * from smv_product_fg_bom_details")
public class CSmvProductFgBomDetails {
	...
	private String product_parent_fg_quantity;
	...
	private String product_parent_fg_oem_part_code;
	private String product_parent_fg_our_part_code;
