...
@Data
@Entity
@Table(name = "xt_weaving_production_sizing_material")
public class CXtWeavingProductionSizingMaterialModel {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "weaving_production_sizing_material_id")
	private int weaving_production_sizing_material_id;
	...
	private Integer weaving_production_sizing_details_id;
