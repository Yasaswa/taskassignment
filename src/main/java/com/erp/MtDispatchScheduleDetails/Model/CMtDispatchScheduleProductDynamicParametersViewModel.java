...
@Entity
@Immutable
@Subselect("select * from  mtv_dispatch_schedule_product_dynamic_parameters")
public class CMtDispatchScheduleProductDynamicParametersViewModel {

	@Id
	private Integer dispatch_schedule_parameter_id;
