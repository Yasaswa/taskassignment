...
@Data
@Entity
@Table(name = "mt_dispatch_schedule_product_dynamic_parameters")
@JsonIgnoreProperties(ignoreUnknown = true)
public class CMtDispatchScheduleProductDynamicParametersModel {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "dispatch_schedule_parameter_id")
	private int dispatch_schedule_parameter_id;
