...
@Data
@Entity
@Table(name = "xtv_spinning_production_rf_wastage")
public class CXtSpinningProductionRfWastageViewModel {
	...
	private double std_wastage_kg;
	private double actual_wastage_production_kg;
	private double actual_wastage_production_percent;
