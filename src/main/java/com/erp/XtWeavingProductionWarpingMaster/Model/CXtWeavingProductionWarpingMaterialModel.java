...
@Setter
@Entity
@Table(name = "xt_weaving_production_warping_material")
public class CXtWeavingProductionWarpingMaterialModel {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "weaving_production_warping_material_id")
	...
	private double consumption_weight;
