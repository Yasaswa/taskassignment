...
@Data
@Entity
@Table(name = "hm_designation_deduction_mapping")
public class CDesignationDeductionMappingModel {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "designation_deduction_mapping_id")
	private int designation_deduction_mapping_id;
