...
@Immutable
@Data
@Subselect("SELECT * FROM hmv_designation_salary_heads_mapping")
public class CDesignationSalaryHeadsMappingViewModel {

	@Id
	private int designation_salary_heads_mapping_id;
