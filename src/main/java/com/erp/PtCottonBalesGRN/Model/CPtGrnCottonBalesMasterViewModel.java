...
@Entity
@Immutable
@Subselect("select * from ptv_grn_cotton_bales_summary")
public class CPtGrnCottonBalesMasterViewModel {
    ...
    private String freight_hsn_sac_code;
    private String freight_hsn_sac_rate;
    ...
    private String gate_entry_date;
