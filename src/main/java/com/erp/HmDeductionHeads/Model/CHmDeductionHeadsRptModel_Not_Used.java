...
@Entity
@Immutable
@Subselect("select * from hmv_deduction_heads_rpt")
public class CHmDeductionHeadsRptModel_Not_Used {
	...
	private String deduction_head_version;
	...
	private String deduction_heads_id;
