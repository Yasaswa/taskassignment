...
@Entity
@Immutable
@Subselect("select * from  xtv_weaving_production_loom_wastage")
public class CXtWeavingProductionLoomWastageViewModel {

	@Id
	private int weaving_production_loom_wastage_id;
