...
@Data
@Entity
@Table(name = "xt_weaving_production_loom_stoppage")
public class CXtWeavingProductionLoomStoppageModel {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "weaving_production_loom_stoppage_id")
	private int weaving_production_loom_stoppage_id;
