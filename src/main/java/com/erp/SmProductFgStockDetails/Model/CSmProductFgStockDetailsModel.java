...
@NoArgsConstructor
@Entity
@Table(name = "sm_product_fg_stock_details")
public class CSmProductFgStockDetailsModel {
	...
	private String godown_id = null;
	private String godown_section_id = null;
	private String godown_section_beans_id = null;
