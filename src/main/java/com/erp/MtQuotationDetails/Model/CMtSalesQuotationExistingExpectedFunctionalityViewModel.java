...
@Entity
@Immutable
@Subselect("select * from mtv_sales_quotation_existing_expected_functionality_trading")
public class CMtSalesQuotationExistingExpectedFunctionalityViewModel {
	...
	public CMtSalesQuotationExistingExpectedFunctionalityViewModel(int quotation_functionality_transaction_id,
	                                                               String quotation_no, String quotation_date, Integer quotation_version,
	                                                               String quotation_existing_functionality, String quotation_expected_functionality,
	                                                               String quotation_expected_value, String company_name, String company_branch_name, String remark,
	...
	public CMtSalesQuotationExistingExpectedFunctionalityViewModel() {
		super();
	}
}
