...
@Data
@Entity
@Table(name = "mt_sales_quotation_payment_terms_trading")
@JsonIgnoreProperties(ignoreUnknown = true)
public class CMtSalesQuotationPaymentTermsTradingModel {
	...
	public CMtSalesQuotationPaymentTermsTradingModel(int quotation_payment_terms_transaction_id, Integer company_id,
	                                                 Integer company_branch_id, Integer quotation_master_transaction_id,
	                                                 Integer quotation_details_transaction_id, Integer payment_terms_id, String quotation_no,
	                                                 String quotation_date, Integer quotation_version, String payment_terms_name, String payment_terms_days,
	                                                 Integer payment_terms_grace_days, String payment_terms_Milestome, String payment_percent, String remark,
	...
	public CMtSalesQuotationPaymentTermsTradingModel() {
		super();
	}
