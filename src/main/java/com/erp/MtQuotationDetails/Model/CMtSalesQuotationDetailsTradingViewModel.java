...
@Entity
@Immutable
@Subselect("select * from mtv_sales_quotation_trading_details")
public class CMtSalesQuotationDetailsTradingViewModel {
...
//	private String product_material_type_short_name;	// Commented because giving error in quotation based so.
//	private String enquiry_type_short_name;				// Commented because giving error in quotation based so.
