...
@Immutable
@Entity
@Subselect(value  = "SELECT * FROM xmv_spinning_prod_count_levels")
public class CXmSpinningProdCountLevelsViewModel {

	@Id
	private int production_count_levels_id;
	...
	private double count_40conversion_electrical;
