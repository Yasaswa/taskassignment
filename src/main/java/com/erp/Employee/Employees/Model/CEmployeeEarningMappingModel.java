...
@Setter
@Entity
@Table(name = "hm_employee_earning_mapping")
public class CEmployeeEarningMappingModel {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "employee_earning_mapping_id")
	private int employee_earning_mapping_id;
