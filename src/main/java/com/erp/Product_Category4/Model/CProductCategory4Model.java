package com.erp.Product_Category4.Model;
...
@Data
@Entity
@Table(name = "sm_product_category4")
public class CProductCategory4Model {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "product_category4_id")
	private int product_category4_id;
