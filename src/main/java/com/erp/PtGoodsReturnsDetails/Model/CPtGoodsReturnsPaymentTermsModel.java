...
@Data
@Entity
@Table(name = "pt_goods_return_payment_terms")
public class CPtGoodsReturnsPaymentTermsModel {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "goods_return_payment_terms_transaction_id")
    private int goods_return_payment_terms_transaction_id;
    private Integer company_id;
    private Integer company_branch_id;

    private Integer goods_return_master_id;
    private Integer goods_return_details_id;
