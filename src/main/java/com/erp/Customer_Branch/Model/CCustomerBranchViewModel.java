...
@Entity
@Immutable
@Subselect("select * from cmv_customer_branch")
public class CCustomerBranchViewModel {

	@Id
	private long cust_branch_id;
	...
	private boolean cust_branch_payment_blocked;
	private String cust_payment_blocked_remark;
	private boolean cust_branch_blocked;
