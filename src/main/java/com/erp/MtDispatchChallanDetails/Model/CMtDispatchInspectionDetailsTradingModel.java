...
@Data
@Entity
@Table(name = "mt_dispatch_inspection_details_trading")
public class CMtDispatchInspectionDetailsTradingModel {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "dispatch_inspection_details_transaction_id")
	private int dispatch_inspection_details_transaction_id;
