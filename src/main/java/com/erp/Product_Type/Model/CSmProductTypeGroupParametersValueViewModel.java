...
@Immutable
@Data
@Subselect("Select * From smv_product_type_group_parameters_values")
public class CSmProductTypeGroupParametersValueViewModel {

	
	@Id
	private int product_type_group_parameters_values_id;
