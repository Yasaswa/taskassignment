ALTER TABLE mt_sales_order_details_trading ADD warp_crimp decimal(18,4) NULL;
ALTER TABLE mt_sales_order_details_trading ADD weft_crimp decimal(18,4) NULL;
ALTER TABLE mt_sales_order_details_trading ADD warp_waste decimal(18,4) NULL;
ALTER TABLE mt_sales_order_details_trading ADD weft_waste decimal(18,4) NULL;

-- erp_development.mtv_sales_order_details_trading source
