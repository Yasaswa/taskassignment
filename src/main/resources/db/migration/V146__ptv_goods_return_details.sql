...
select
    ...
    concat(`v`.`product_type_id`, ':Product Type Id:O:N:') as `service_planning_master_transaction_id`,
    concat(`v`.`supplier_id`, ':Supplier Id:N:N:') as `service_planning_details_transaction_id`
from
