UPDATE am_modules_forms
	SET listing_component_import_path='import CottonBalesIndentListing from "Transactions/TPurchaseOrder/Indent/CottonBalesIndentListing";',listing_navigation_url='/Transactions/TPurchaseOrder/Indent/CottonBalesIndentListing',listing_component_name='<CottonBalesIndentListing />'
	WHERE modules_forms_name='Indent (Cotton Bales)' and display_name='Purch. Indent (Cotton Bales)' and page_header='Indent (Cotton Bales)';


ALTER TABLE st_indent_master ADD category_1 bigint(20);
ALTER TABLE st_indent_master ADD category_2 bigint(20);
