ALTER TABLE xt_weaving_production_warping_bottom_details ADD package_type varchar(500) NULL;
ALTER TABLE xt_weaving_production_warping_bottom_details ADD cone_type varchar(100) NULL;
ALTER TABLE xt_weaving_production_warping_bottom_details ADD cone_type_value decimal(18,4) NULL;
ALTER TABLE xt_weaving_production_warping_bottom_details ADD warping_bottom_details_production_date date NOT NULL;
ALTER TABLE xt_weaving_production_warping_bottom_details ADD sr_no varchar(500) NULL;
ALTER TABLE xt_weaving_production_warping_bottom_details ADD batch_no varchar(500) NULL;
ALTER TABLE xt_weaving_production_warping_bottom_details ADD product_rm_id varchar(55) NULL;
ALTER TABLE xt_weaving_production_warping_bottom_details ADD weight_per_pkg decimal(18,4) NULL;


ALTER TABLE xt_weaving_production_warping_bottom_details MODIFY COLUMN cone_type_value decimal(18,4) DEFAULT 0 NULL;

UPDATE xt_weaving_production_warping_bottom_details SET cone_type_value = 0.000;
ALTER TABLE xt_weaving_production_warping_master ADD batch_no varchar(500) DEFAULT NULL NULL;
...
left join (
    select
        ...
        sum(`st_indent_material_issue_details`.`product_material_indent_quantity`) as `warping_issue_quantity`,
