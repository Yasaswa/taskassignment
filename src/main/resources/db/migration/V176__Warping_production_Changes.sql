-- Delete down from xt_weaving_production_warping_details
ALTER TABLE xt_weaving_production_warping_details DROP COLUMN IF EXISTS no_of_creels;
ALTER TABLE xt_weaving_production_warping_details DROP COLUMN IF EXISTS total_pkg_used;
ALTER TABLE xt_weaving_production_warping_details DROP COLUMN IF EXISTS net_weight;
ALTER TABLE xt_weaving_production_warping_details DROP COLUMN IF EXISTS exp_bottom;
ALTER TABLE xt_weaving_production_warping_details DROP COLUMN IF EXISTS act_bottom;
ALTER TABLE xt_weaving_production_warping_details DROP COLUMN IF EXISTS bottom_percent;



-- Changes in xtv_weaving_production_warping_master;
...
-- xtv_weaving_production_warping_master_rpt source
...
-- xtv_weaving_production_warping_details_rpt source
...
-- xtv_weaving_production_warping_material source
