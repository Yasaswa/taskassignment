ALTER TABLE pt_material_gate_pass_master ADD product_category1_id bigint(20) DEFAULT NULL NULL;
ALTER TABLE pt_material_gate_pass_master ADD product_category2_id bigint(20) DEFAULT NULL NULL;
...
select
    ...
    `pmgpm`.`product_category1_id` as `product_category1_id`,
    `pmgpm`.`product_category2_id` as `product_category2_id`,
