ALTER TABLE st_indent_material_issue_return_details ADD issue_batch_no varchar(100) NULL;

ALTER TABLE st_indent_material_issue_return_details ADD cone_per_wt decimal(18, 4) DEFAULT 0.0000 NULL;
...
-- erp_dev_temp.stv_indent_material_issue_return_master source
...
ALTER TABLE sm_product_rm_stock_details ADD production_issue_return_boxes bigint(20) DEFAULT 0 NULL;
ALTER TABLE sm_product_rm_stock_summary ADD production_issue_return_boxes bigint(20) DEFAULT 0 NULL;
...
where
    ...
    ALTER TABLE st_indent_material_issue_return_details MODIFY COLUMN product_material_receipt_boxes BIGINT(20) DEFAULT NULL NULL;
