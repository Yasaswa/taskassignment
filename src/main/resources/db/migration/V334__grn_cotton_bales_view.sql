ALTER TABLE pt_grn_cotton_bales_master ADD supplier_id bigint(20) NOT NULL;
ALTER TABLE pt_grn_cotton_bales_master MODIFY COLUMN goods_receipt_status varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'P' NULL COMMENT '  2/7  footer part read only combo G-GRN Done, Q-QC Done, R-Rejected,I-Partial Receipt, C-Completed, X-Canceled  will changes according to trnasactions  done ';
...
INSERT INTO am_modules_forms (company_id,company_branch_id,module_id,sub_module_id,modules_menu_id,modules_sub_menu_id,modules_forms_name,display_sequence,display_name,menu_type,listing_component_name,listing_component_import_path,listing_navigation_url,form_component_name,form_component_import_path,form_navigation_url,icon_class,page_header,is_selected,is_active,is_delete,created_by,created_on,modified_by,modified_on,deleted_by,deleted_on,is_protected,header,footer,url_parameter) VALUES
	 (1,1,1,16,2,10,'Goods Receipt Notes(Cotton Bales)',1,'Goods Receipt Notes(Cotton Bales)','Purchase','<FrmGoodsReceiptNoteCottonBalesListing />','import FrmGoodsReceiptNoteCottonBalesListing from "Transactions/TPurchaseOrder/GoodsReceiptNote/FrmGoodsReceiptNoteCottonBalesListing";','/Transactions/TPurchaseOrder/GoodsReceiptNote/GoodsReceiptNoteCottonBalesListing','<FrmGoodsReceiptNoteCottonBalesEntry />','import FrmGoodsReceiptNoteCottonBalesEntry from "Transactions/TPurchaseOrder/GoodsReceiptNote/FrmGoodsReceiptNoteCottonBalesEntry";','/Transactions/TPurchaseOrder/GoodsReceiptNote/GoodsReceiptNoteCottonBalesEntry',NULL,'Goods Receipt Notes (Cotton Bales)',0,1,0,NULL,NULL,NULL,NULL,NULL,NULL,0,1,1,'');

ALTER TABLE sm_product_material_stock_new MODIFY COLUMN batch_no varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '0' NULL COMMENT '* NO Front End Only  Back End Entry Data will come from respective transaction will updated on transaction to transaction level *';
