ALTER TABLE pt_material_gate_pass_master ADD department_id BIGINT(10) NULL;
ALTER TABLE pt_material_gate_pass_master ADD sub_department_id BIGINT(10) NULL;
...
select
    ...
    concat(ifnull(`v`.`return_status_desc`, ''), ':Return Gate Pass Status:O:N:') as `return_status_desc`,
...
ALTER TABLE pt_material_return_gate_pass_master ADD department_id bigint(10) NULL;
ALTER TABLE pt_material_return_gate_pass_master ADD sub_department_id BIGINT(10) NULL;
