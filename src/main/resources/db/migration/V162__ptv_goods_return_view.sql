ALTER TABLE pt_goods_return_details ADD godown_id int(11) NULL;
ALTER TABLE pt_goods_return_details ADD godown_section_id int(11) NULL;
ALTER TABLE pt_goods_return_details ADD godown_section_beans_id int(11) NULL;

ALTER TABLE pt_goods_return_master ADD financial_year varchar(100) NULL;


ALTER TABLE pt_goods_return_details ADD issue_batch_no varchar(100) NULL;
ALTER TABLE pt_goods_return_details ADD cone_per_wt decimal(18,4) NULL;
ALTER TABLE pt_goods_return_details ADD financial_year varchar(100) NULL;
...
-- erp_development.ptv_goods_return_master_rpt source
...
-- erp_development.ptv_goods_return_details_rpt source
