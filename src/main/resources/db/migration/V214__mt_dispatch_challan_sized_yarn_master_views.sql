ALTER TABLE mt_dispatch_challan_sized_yarn_master DROP COLUMN gate_pass_no;
ALTER TABLE mt_dispatch_challan_sized_yarn_master DROP COLUMN gate_pass_date;
ALTER TABLE mt_dispatch_challan_sized_yarn_master DROP COLUMN vehical_no;
ALTER TABLE mt_dispatch_challan_sized_yarn_master DROP COLUMN container_no;
ALTER TABLE mt_dispatch_challan_sized_yarn_master DROP COLUMN driver_contact_no;
ALTER TABLE mt_dispatch_challan_sized_yarn_master DROP COLUMN vehicle_reporting_time;
ALTER TABLE mt_dispatch_challan_sized_yarn_master DROP COLUMN vehicle_loading_started_time;
ALTER TABLE mt_dispatch_challan_sized_yarn_master DROP COLUMN vehicle_loading_finish_time;

ALTER TABLE mt_dispatch_challan_sized_yarn_details ADD dispatch_challan_date date NULL;
ALTER TABLE mt_dispatch_challan_sized_yarn_details ADD dispatch_challan_version bigint(20) DEFAULT 1 NULL;
ALTER TABLE mt_dispatch_challan_sized_yarn_details ADD dispatch_challan_type_id bigint(20) NULL;
ALTER TABLE mt_dispatch_challan_sized_yarn_details ADD dispatch_challan_creation_type varchar(10) DEFAULT 'M' NULL;
